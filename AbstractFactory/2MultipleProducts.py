...
def main():
    ...
    # Vanilla Products
    factory = VanillaProductsFactory()
    ...
    # Secure Products
    factory = SecureProductsFactory()
    product_a = factory.create_browser()
    product_b = factory.create_messenger()
    product_a.create_browser_window()
    product_a.create_search_toolbar()
    product_a.create_incognito_mode()
    product_b.create_messenger_window()
    product_b.create_privacy_filter()
    product_b.disappearing_messages()
